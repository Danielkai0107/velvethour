      ...
      if (dressId === "demo-dress-1") {
        return [
          {
            合約單號: "20250921-001",
            客戶姓名: "張小姐",
            租用開始時間: new Date("2025-09-25T14:00:00"),
            租用結束時間: new Date("2025-09-26T18:00:00"),
            下次可用時間: new Date("2025-10-02T09:00:00"),
            處理狀態: "進行中",
        ...
        return [
          ...
          },
          {
            合約單號: "20250921-002",
            客戶姓名: "李太太",
            租用開始時間: new Date("2025-09-28T16:00:00"),
            租用結束時間: new Date("2025-09-29T20:00:00"),
            下次可用時間: new Date("2025-10-05T09:00:00"),
            處理狀態: "已確認",
        ...
        return [
          {
            合約單號: "20250921-003",
            客戶姓名: "王小姐",
            租用開始時間: new Date("2025-09-22T12:00:00"),
            租用結束時間: new Date("2025-09-22T22:00:00"),
            下次可用時間: new Date("2025-09-29T09:00:00"),
            處理狀態: "已確認",
      ...
      return [
        {
          id: "demo-contract-1",
          合約單號: "20250921-001",
          合約建立日期時間: new Date("2025-09-21T10:30:00"),
          租用開始時間: new Date("2025-09-25T14:00:00"),
          租用結束時間: new Date("2025-09-26T18:00:00"),
          下次可用時間: new Date("2025-10-02T09:00:00"),
          處理狀態: "進行中",
          ...
          創建時間: new Date("2025-09-21T10:30:00"),
          更新時間: new Date("2025-09-21T10:30:00"),
        },
        {
          id: "demo-contract-2",
          合約單號: "20250921-002",
          合約建立日期時間: new Date("2025-09-21T14:20:00"),
          租用開始時間: new Date("2025-09-28T16:00:00"),
          租用結束時間: new Date("2025-09-29T20:00:00"),
          下次可用時間: new Date("2025-10-05T09:00:00"),
          處理狀態: "已確認",
          ...
          創建時間: new Date("2025-09-21T14:20:00"),
          更新時間: new Date("2025-09-21T14:20:00"),
        },
        {
          id: "demo-contract-3",
          合約單號: "20250921-003",
          合約建立日期時間: new Date("2025-09-21T09:15:00"),
          租用開始時間: new Date("2025-09-22T12:00:00"),
          租用結束時間: new Date("2025-09-22T22:00:00"),
          下次可用時間: new Date("2025-09-29T09:00:00"),
          處理狀態: "已確認",
          ...
          合約總金額: 5000,
          備注: "婚禮拍攝用途，客戶要求當天取件。",
          創建時間: new Date("2025-09-21T09:15:00"),
          更新時間: new Date("2025-09-21T09:15:00"),
        },
      ];
    }
  },
